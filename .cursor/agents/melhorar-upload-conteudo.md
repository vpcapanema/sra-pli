...
description: >-
  ...
  Foco em importacao.py, `secao_edit_conteudo_upload.html` e fluxo existente — nao redesenhar a app inteira.
model: inherit
---
...
- **Ficheiros prioritarios:** `app/routes/importacao.py`, `app/templates/secao_edit_conteudo_upload.html`; quando necessario `app/models.py`, templates PDF e [project-instructions.md](../project-instructions.md).
