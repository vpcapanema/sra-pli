...
Lógica completa das rotas em ``app/routes/modelos_word.py``.
"""
...
def pagina_modelos_word_importacao(request: Request, db: Session):
...
def baixar_modelo_catalogo(arquivo: str, request: Request, db: Session):
